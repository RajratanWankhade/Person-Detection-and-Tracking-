...
Original file is located at
    https://colab.research.google.com/drive/19eeVkkcpGHH669SPZPHpC7xNZ3lddqCi
"""
    ...
    for i, box in enumerate(bbox):
        ...
        if len(data_deque[id]) >= 2:
          ...
          if intersect(data_deque[id][0] , data_deque[id][1] , line[0] ,line[1]) :
            # cv2.line(img, line[1] ,(255,255,255), 3)
            cv2.line(img, (2, 597), (1900, 597), (0, 255, 0), thickness=2)
        ...
        for idx, (key, value) in enumerate(object_counter.items()):
            ...
            cv2.putText(img, f'Count of People Enetering', (width - 500, 35), 0, 1, [225,0, 0], thickness=2, lineType=cv2.LINE_AA)
            ###
        ...
        for idx, (key, value) in enumerate(object_counter1.items()):
            ...
            cv2.putText(img, f'People Leaving', (11, 35), 0, 1, [225, 0, 0], thickness=2, lineType=cv2.LINE_AA) 
